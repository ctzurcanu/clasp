...
pub extern "C" fn cc_funcall_stack(func_ref: usize, num_args: i64) {
    ...
    // Print all calls to debug the crash
    let debug_enabled = false;  // Disable verbose tracing
    ...
    if debug_enabled {
        ...
        eprintln!("[funcall_stack #{}] {} (args={}, depth={})", count, name_str, num_args, depth_before);
