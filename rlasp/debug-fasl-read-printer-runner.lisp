...
(clasp-tests::message :emph "~%Running read01 suite...")
(let ((suite-file "/Users/christiantzurcanu/Documents/dev/clasp/rlasp/clisp/in_work/regression-tests/read01.lisp"))
  (handler-case
    ...
    (error (e)
      ...
      (clasp-tests::message :err "Regression: compile-file of ~a failed with ~a" suite-file e))))
(clasp-tests::reset-clasp-tests)
