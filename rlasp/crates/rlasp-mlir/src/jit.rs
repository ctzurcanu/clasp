...
pub fn parse_llvm_ir<'ctx>(context: &'ctx Context, llvm_ir: &str) -> Result<Module<'ctx>> {
    ...
    let module = Module::parse_bitcode_from_path(&temp_file, context).or_else(|_| {
...
mod tests {
    ...
    fn test_mlir_jit_constant() {
        ...
        unsafe {
            ...
            let func: inkwell::execution_engine::JitFunction<unsafe extern "C" fn() -> i64> = jit
                .execution_engine()
                .get_function("test_const_func")
    ...
    fn test_mlir_jit_addition() {
        ...
        unsafe {
            ...
            let func: inkwell::execution_engine::JitFunction<unsafe extern "C" fn(i64) -> i64> =
                jit.execution_engine()
                    .get_function("test_add_func")
                    .expect("Failed to get function");
