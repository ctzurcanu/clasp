...
impl<'ctx> JitEngine<'ctx> {
    ...
    pub fn new(mut module: Module<'ctx>) -> Result<Self, String> {
        ...
        let intrinsic_names = [
            ...
            "cc_argv",
            "cc_box_function_ptr",
            "cc_unbox_function_ptr",
            "cc_is_function",
            // IO syntax intrinsics for with-standard-io-syntax
            "cc_save_io_syntax_state",
            "cc_restore_io_syntax_state",
            "cc_set_standard_io_syntax",
            "cc_get_io_syntax_var",
            "cc_set_io_syntax_var",
            "cc_is_io_syntax_var",
        ];
        ...
        use rlasp_runtime::io_syntax::{
            cc_get_io_syntax_var, cc_is_io_syntax_var, cc_restore_io_syntax_state,
            cc_save_io_syntax_state, cc_set_io_syntax_var, cc_set_standard_io_syntax,
        };
        let addrs: &[usize] = &[
            cc_box_fixnum as usize,
            cc_unbox_fixnum as usize,
            cc_box_float as usize,
            cc_box_single_float as usize,
            cc_unbox_float as usize,
            cc_cons as usize,
            cc_car as usize,
            cc_cdr as usize,
            cc_nil as usize,
            ...
            cc_format as usize,
            cc_make_hash_table as usize,
            cc_make_hash_table_full as usize,
            cc_gethash as usize,
            cc_puthash as usize,
            cc_maphash as usize,
            cc_make_vector as usize,
            cc_svset as usize,
            cc_svref as usize,
            cc_vector_length as usize,
            cc_make_instance as usize,
            cc_slot_value as usize,
            cc_set_slot_value as usize,
            cc_system as usize,
            cc_print as usize,
            cc_echo as usize,
            ...
            cc_ls as usize,
            cc_pwd as usize,
            cc_make_string as usize,
            cc_shell as usize,
            cc_argc as usize,
            cc_argv as usize,
            cc_box_function_ptr as usize,
            cc_unbox_function_ptr as usize,
            cc_is_function as usize,
            // IO syntax intrinsics
            cc_save_io_syntax_state as usize,
            cc_restore_io_syntax_state as usize,
            cc_set_standard_io_syntax as usize,
            cc_get_io_syntax_var as usize,
            cc_set_io_syntax_var as usize,
            cc_is_io_syntax_var as usize,
        ];
    ...
    pub unsafe fn get_function_0(
        &self,
        name: &str,
    ) -> Result<JitFunction<unsafe extern "C" fn() -> usize>, String> {
    ...
    pub unsafe fn get_function_2(
        &self,
        name: &str,
    ) -> Result<JitFunction<unsafe extern "C" fn(usize, usize) -> usize>, String> {
        self.execution_engine
            .get_function(name)
            .map_err(|e| format!("Function '{}' not found: {}", name, e))
    }
