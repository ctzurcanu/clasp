module {
  ...
  func.func @"__main"() {
    ...
    %17 = scf.if %16 -> (i64) {
      ...
      %52 = func.call @cc_cons(%51, %47) : (i64, i64) -> i64
      func.call @stack_push_pointer(%12) : (i64) -> ()
      %53 = func.call @stack_pop_pointer() : () -> i64
      %54 = func.call @cc_cons(%53, %52) : (i64, i64) -> i64
      %55 = func.call @cc_concatenate(%46, %54) : (i64, i64) -> i64
      ...
      func.call @cc_funcall_stack(%58, %59) : (i64, i64) -> ()
  ...
  llvm.mlir.global private constant @str1("s=~S len=~S code=~S concat=~S~%\00") : !llvm.array<32 x i8>
  llvm.mlir.global private constant @str2("STRING\00") : !llvm.array<7 x i8>
  llvm.mlir.global private constant @str3("COMMON-LISP\00") : !llvm.array<12 x i8>
  llvm.mlir.global private constant @str4("Z\00") : !llvm.array<2 x i8>
  llvm.mlir.global private constant @str5("FORMAT\00") : !llvm.array<7 x i8>
}
