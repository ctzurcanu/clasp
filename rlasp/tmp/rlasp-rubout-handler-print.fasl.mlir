module {
  ...
  func.func @"__main"() {
    ...
    %29 = scf.if %28 -> (i64) {
      ...
      %68 = scf.if %67 -> (i64) {
        ...
        %84 = scf.if %83 -> (i64) {
          ...
          %117 = func.call @cc_typep(%116, %115) : (i64, i64) -> i64
          ...
          %125 = func.call @cc_class_of(%124) : (i64) -> i64
    ...
    %137 = func.call @cc_set_symbol_value(%22, %23) : (i64, i64) -> i64
  ...
  llvm.mlir.global private constant @str8("reader-handler type-reader=~S type-error=~S type-of=~S class=~S str=~S~%\00") : !llvm.array<73 x i8>
  llvm.mlir.global private constant @str9("READER-ERROR\00") : !llvm.array<13 x i8>
  llvm.mlir.global private constant @str10("COMMON-LISP\00") : !llvm.array<12 x i8>
  llvm.mlir.global private constant @str11("ERROR\00") : !llvm.array<6 x i8>
  llvm.mlir.global private constant @str12("COMMON-LISP\00") : !llvm.array<12 x i8>
  llvm.mlir.global private constant @str13("TYPE-OF\00") : !llvm.array<8 x i8>
  llvm.mlir.global private constant @str14("WRITE-TO-STRING\00") : !llvm.array<16 x i8>
