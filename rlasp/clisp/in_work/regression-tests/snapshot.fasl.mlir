module {
  ...
  func.func @"__main"() {
    ...
    %44 = arith.addi %40, %__rlasp_stack_elide_zero_0 : i64
    %45 = func.call @cc_in_package(%44) : (i64) -> i64
    %__rlasp_stack_elide_zero_1 = arith.constant 0 : i64
    %46 = arith.addi %45, %__rlasp_stack_elide_zero_1 : i64
    %47 = func.call @cc_multiple_value_list(%46) : (i64) -> i64
    %48 = llvm.mlir.addressof @str5 : !llvm.ptr
    %49 = arith.constant 38 : i64
    ...
    %57 = llvm.mlir.addressof @str6 : !llvm.ptr
    %58 = arith.constant 40 : i64
    ...
    %65 = func.call @cc_symbol_value(%61) : (i64) -> i64
    %66 = func.call @cc_nil_value() : () -> i64
    %67 = arith.cmpi ne, %56, %66 : i64
    %68 = scf.if %67 -> (i64) {
      scf.yield %65 : i64
    } else {
      scf.yield %47 : i64
  ...
  llvm.mlir.global private constant @str1("*__MLIR_BLOCK_RETFLAG_113992307572736*\00") : !llvm.array<39 x i8>
  llvm.mlir.global private constant @str2("*__MLIR_BLOCK_RETVALUE_113992307572736*\00") : !llvm.array<40 x i8>
  llvm.mlir.global private constant @str3("*__MLIR_BLOCK_RETMVLIST_113992307572736*\00") : !llvm.array<41 x i8>
  llvm.mlir.global private constant @str4("CLASP-TESTS\00") : !llvm.array<12 x i8>
  llvm.mlir.global private constant @str5("*__MLIR_BLOCK_RETFLAG_113992307572736*\00") : !llvm.array<39 x i8>
  llvm.mlir.global private constant @str6("*__MLIR_BLOCK_RETMVLIST_113992307572736*\00") : !llvm.array<41 x i8>
}
