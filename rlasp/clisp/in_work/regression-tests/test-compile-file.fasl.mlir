module {
  ...
  func.func @"%FN%CLASP-TESTS::FOO"() {
    ...
    %10 = func.call @cc_nil_value() : () -> i64
    %11 = llvm.mlir.addressof @str2 : !llvm.ptr
    %12 = arith.constant 37 : i64
    %13 = func.call @cc_make_string(%11, %12) : (!llvm.ptr, i64) -> i64
    %14 = func.call @cc_nil_value() : () -> i64
    %15 = func.call @cc_intern(%13, %14) : (i64, i64) -> i64
    %16 = func.call @cc_nil_value() : () -> i64
    %17 = func.call @cc_cons(%15, %16) : (i64, i64) -> i64
    %18 = func.call @cc_values_pack(%17) : (i64) -> i64
    %19 = func.call @cc_set_symbol_value(%15, %10) : (i64, i64) -> i64
    %20 = llvm.mlir.addressof @str3 : !llvm.ptr
    %21 = arith.constant 38 : i64
    %22 = func.call @cc_make_string(%20, %21) : (!llvm.ptr, i64) -> i64
    %23 = func.call @cc_nil_value() : () -> i64
    %24 = func.call @cc_intern(%22, %23) : (i64, i64) -> i64
    %25 = func.call @cc_nil_value() : () -> i64
    %26 = func.call @cc_cons(%24, %25) : (i64, i64) -> i64
    %27 = func.call @cc_values_pack(%26) : (i64) -> i64
    %28 = func.call @cc_set_symbol_value(%24, %10) : (i64, i64) -> i64
    %29 = llvm.mlir.addressof @str4 : !llvm.ptr
    %30 = arith.constant 39 : i64
    %31 = func.call @cc_make_string(%29, %30) : (!llvm.ptr, i64) -> i64
    %32 = func.call @cc_nil_value() : () -> i64
    %33 = func.call @cc_intern(%31, %32) : (i64, i64) -> i64
    %34 = func.call @cc_nil_value() : () -> i64
    %35 = func.call @cc_cons(%33, %34) : (i64, i64) -> i64
    %36 = func.call @cc_values_pack(%35) : (i64) -> i64
    %37 = func.call @cc_set_symbol_value(%33, %10) : (i64, i64) -> i64
    %38 = arith.constant 42 : i64
    func.call @stack_push_fixnum(%38) : (i64) -> ()
    %39 = func.call @stack_pop_pointer() : () -> i64
    %40 = func.call @cc_multiple_value_list(%39) : (i64) -> i64
    %41 = llvm.mlir.addressof @str5 : !llvm.ptr
    %42 = arith.constant 37 : i64
    ...
    %49 = func.call @cc_symbol_value(%45) : (i64) -> i64
    %50 = llvm.mlir.addressof @str6 : !llvm.ptr
    %51 = arith.constant 39 : i64
    ...
    %58 = func.call @cc_symbol_value(%54) : (i64) -> i64
    %59 = func.call @cc_nil_value() : () -> i64
    %60 = arith.cmpi ne, %49, %59 : i64
    %61 = scf.if %60 -> (i64) {
      scf.yield %58 : i64
    } else {
      scf.yield %40 : i64
  ...
  func.func @"__main"() {
    ...
    %80 = func.call @cc_set_symbol_value(%76, %71) : (i64, i64) -> i64
    %81 = llvm.mlir.addressof @str9 : !llvm.ptr
    %82 = arith.constant 38 : i64
    ...
    %89 = func.call @cc_set_symbol_value(%85, %71) : (i64, i64) -> i64
    %90 = llvm.mlir.addressof @str10 : !llvm.ptr
    %91 = arith.constant 39 : i64
    ...
    %98 = func.call @cc_set_symbol_value(%94, %71) : (i64, i64) -> i64
    %99 = llvm.mlir.addressof @str11 : !llvm.ptr
    ...
    %109 = arith.addi %105, %__rlasp_stack_elide_zero_0 : i64
    %110 = func.call @cc_in_package(%109) : (i64) -> i64
    %__rlasp_stack_elide_zero_1 = arith.constant 0 : i64
    %111 = arith.addi %110, %__rlasp_stack_elide_zero_1 : i64
    %112 = func.call @cc_multiple_value_list(%111) : (i64) -> i64
    %113 = llvm.mlir.addressof @str13 : !llvm.ptr
    ...
    %122 = llvm.mlir.addressof @str14 : !llvm.ptr
  ...
  llvm.mlir.global private constant @str5("*__MLIR_BLOCK_RETFLAG_98668451463168*\00") : !llvm.array<38 x i8>
  llvm.mlir.global private constant @str6("*__MLIR_BLOCK_RETMVLIST_98668451463168*\00") : !llvm.array<40 x i8>
  ...
  llvm.mlir.global private constant @str11("CL-USER\00") : !llvm.array<8 x i8>
  llvm.mlir.global private constant @str12("KEYWORD\00") : !llvm.array<8 x i8>
  llvm.mlir.global private constant @str13("*__MLIR_BLOCK_RETFLAG_98668451463169*\00") : !llvm.array<38 x i8>
  llvm.mlir.global private constant @str14("*__MLIR_BLOCK_RETMVLIST_98668451463169*\00") : !llvm.array<40 x i8>
}
