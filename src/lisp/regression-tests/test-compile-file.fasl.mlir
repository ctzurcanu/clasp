module {
  ...
  func.func @"%FN%foo"() {
    ...
    %36 = arith.constant 42 : i64
    func.call @stack_push_fixnum(%36) : (i64) -> ()
    %37 = func.call @stack_pop_pointer() : () -> i64
    %38 = func.call @cc_multiple_value_list(%37) : (i64) -> i64
    %39 = llvm.mlir.addressof @str4 : !llvm.ptr
    %40 = arith.constant 37 : i64
  ...
  func.func @"__main"() {
    ...
    %70 = llvm.mlir.addressof @str7 : !llvm.ptr
    ...
    %78 = func.call @cc_set_symbol_value(%74, %69) : (i64, i64) -> i64
    ...
    %87 = func.call @cc_set_symbol_value(%83, %69) : (i64, i64) -> i64
    ...
    %96 = func.call @cc_set_symbol_value(%92, %69) : (i64, i64) -> i64
    ...
    %107 = arith.addi %103, %__rlasp_stack_elide_zero_0 : i64
    %108 = func.call @cc_in_package(%107) : (i64) -> i64
    %__rlasp_stack_elide_zero_1 = arith.constant 0 : i64
    %109 = arith.addi %108, %__rlasp_stack_elide_zero_1 : i64
    %110 = func.call @cc_multiple_value_list(%109) : (i64) -> i64
    %111 = llvm.mlir.addressof @str12 : !llvm.ptr
    %112 = arith.constant 37 : i64
    ...
    %119 = func.call @cc_symbol_value(%115) : (i64) -> i64
    %120 = llvm.mlir.addressof @str13 : !llvm.ptr
    %121 = arith.constant 39 : i64
  ...
  llvm.mlir.global private constant @str4("*__MLIR_BLOCK_RETFLAG_98668451463168*\00") : !llvm.array<38 x i8>
  llvm.mlir.global private constant @str5("*__MLIR_BLOCK_RETMVLIST_98668451463168*\00") : !llvm.array<40 x i8>
  llvm.mlir.global private constant @str6("__MAIN\00") : !llvm.array<7 x i8>
  ...
  llvm.mlir.global private constant @str10("CL-USER\00") : !llvm.array<8 x i8>
  llvm.mlir.global private constant @str11("KEYWORD\00") : !llvm.array<8 x i8>
  llvm.mlir.global private constant @str12("*__MLIR_BLOCK_RETFLAG_98668451463169*\00") : !llvm.array<38 x i8>
  llvm.mlir.global private constant @str13("*__MLIR_BLOCK_RETMVLIST_98668451463169*\00") : !llvm.array<40 x i8>
}
